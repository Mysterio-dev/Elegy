(() => {
    var __webpack_modules__ = {
        2711: function(module, __unused_webpack_exports, __webpack_require__) {
            !function(e, t) {
 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".features__slider")) new core(".features__slider", {
        ...
        DG.then((function() {
            var map = DG.map("map", {
                center: [ 55.826515, 49.042221 ],
                zoom: 17
            });
            DG.marker([ 55.826515, 49.042221 ]).addTo(map).bindPopup("ЖК Элегия");
        }));
        DG.then((function() {
            var map = DG.map("map-contacts", {
                center: [ 55.814654, 49.052353 ],
                zoom: 17
            });
            DG.marker([ 55.814654, 49.052353 ]).addTo(map).bindPopup("Отдел продаж");
        }));
